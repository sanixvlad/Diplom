...
namespace Diplom
{
    public class SlidingTabStrip : LinearLayout
    {
        ...
        //Tab colorizer
        private SlidingTabScrolView.TabColorizer mCustomTabColorizer;
        ...
        public SlidingTabScrolView.TabColorizer CustomTabColorizer
        {
            set
            {
        ...
        protected override void OnDraw(Canvas canvas)
        {
            ...
            SlidingTabScrolView.TabColorizer tabColorizer = mCustomTabColorizer != null ? mCustomTabColorizer : mDefaultTabColorizer;
        ...
        private class SimpleTabColorizer : SlidingTabScrolView.TabColorizer
        {
